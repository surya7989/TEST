                    ...
                    stockAnalytics.filteredProducts.map((p) => {
                      ...
                      return (
                        <tr key={p.id} className="hover:bg-slate-50/80 transition-colors">
                          ...
                          <td className="py-3 px-4 text-right font-mono font-semibold text-[#147A7A]">
                            {formatCurrency(totalVal)}
                          </td>
                          <td className="py-3 px-3 text-center">
                            {p.gstType === 'gst-free' ? (
                              <span className="text-[10px] font-medium text-teal-800 bg-teal-50 px-2 py-0.5 rounded border border-teal-200/60">
                                0% GST-Free
                              </span>
                            ) : p.gstType === 'custom' ? (
                              <span className="text-[10px] font-medium text-teal-700 bg-teal-50 px-2 py-0.5 rounded border border-teal-200/60">
                                {p.gstRate || 10}% GST
                              </span>
                            ) : (
