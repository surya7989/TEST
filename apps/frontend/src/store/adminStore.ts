          ...
          if (quotesRes.status === 'fulfilled' && quotesRes.value.quotes) {
            set({
              ndisQuotes: quotesRes.value.quotes.map((q: any) => ({
                ...
                planType: (q.plan_type || 'plan_managed') as any,
                ...
                quoteType: (q.quoteType || q.quote_type || 'purchase') as any,
                prescriberName: q.prescriberName || '',
                prescriberOrg: q.prescriberOrg || '',
                prescriberPhone: q.prescriberPhone || '',
                prescriberEmail: q.prescriberEmail || '',
                clinicalRationale: q.clinicalRationale || '',
                participantDob: q.participantDob || '',
                hireStartDate: q.hireStartDate || '',
                hireReturnDate: q.hireReturnDate || '',
                hireDurationWeeks: Number(q.hireDurationWeeks || 4),
                hireLocationType: (q.hireLocationType || '') as any,
                hireFacilityName: q.hireFacilityName || '',
                hireFacilityWard: q.hireFacilityWard || '',
                hireFacilityRoom: q.hireFacilityRoom || '',
                hireDischargeDate: q.hireDischargeDate || '',
